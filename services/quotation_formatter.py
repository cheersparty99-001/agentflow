...
DEMO_POLICIES_QUOTATION = [
    {
        ...
        "car_year": 2020, "car_plate": "WXY 1234", "ncd": "25%",
        "coverage_type": "Comprehensive", "sum_insured": 85000,
        "expiry_date": (date.today() + timedelta(days=30)).isoformat(),
    },
    {
        "id": "q-demo-2", "customer_name": "Siti Fatimah", "phone": "60167778889",
        "ic_number": "850615-08-5678", "email": "siti@email.com",
        "insurance_type": "medical", "dependents": 2,
        "coverage_type": "Hospital & Surgical", "sum_insured": 500000,
        "expiry_date": (date.today() + timedelta(days=60)).isoformat(),
    },
    {
        "id": "q-demo-3", "customer_name": "Lim Chee Keong", "phone": "60112223334",
        "ic_number": "780301-14-9012", "email": "lim@email.com",
        "insurance_type": "fire", "property_address": "12, Jalan SS2/72, Petaling Jaya",
        "property_type": "Terrace House", "sum_insured": 350000,
        "expiry_date": (date.today() + timedelta(days=44)).isoformat(),
    },
    {
        "id": "q-demo-4", "customer_name": "Emily Wong", "phone": "60156667770",
        "ic_number": "921201-08-3456", "email": "emily@email.com",
