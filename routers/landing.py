...
BLOG_POSTS = {
    "why-whatsapp-beats-email": {
        ...
        "author": "Flowreach Team",
        "author_role": "B2B Sales Automation",
        "author_bio": "Insights on B2B sales, AI automation, and growing your pipeline in Malaysia and Southeast Asia.",
        "date": "May 26, 2026",
        "read_minutes": 5,
        "tag": "Sales",
        "cover_emoji": "💬",
        "body": [
            ...
            "Industry research consistently shows WhatsApp messages achieve significantly higher open and reply rates compared to email, particularly in Southeast Asian markets where WhatsApp is the primary business communication channel.",
    ...
    "cost-of-salesperson-vs-ai": {
        ...
        "body": [
            ...
            "The math is clear: AI handles prospecting and initial outreach at a fraction of the cost of a human SDR. Your best salespeople should be spending their time on closing, not finding leads."
        ]
    },
    ...
    "b2b-sales-malaysia-2026": {
        ...
        "body": [
            ...
            "What's working in Malaysian B2B sales right now: personalised WhatsApp outreach, AI-powered lead scoring (removes guesswork), multi-language messaging (English, BM, and Chinese depending on the prospect), and fast follow-ups (within 2 hours of a prospect showing interest).",
    ...
    "cold-outreach-messages-that-work": {
        ...
        "cover_emoji": "✍️",
        "body": [
            "The most effective cold outreach messages share three structural principles.",
            ...
            "At Flowreach, we encode all three principles into every outreach message. The AI reads the prospect's industry, location, and business type, then generates personalised copy that follows this exact structure.",
